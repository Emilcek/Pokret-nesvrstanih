		...
		\end{itemize}
			...
			\subsection{Opis tablica}
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue} Researcher	& VARCHAR &   identifikator istraživača koji šalje zahtjev	\\ \hline
					\SetCell{LightBlue} StationLead	& VARCHAR &   identifikator voditelja koji prima zahtjev	\\ \hline 
				\end{longtblr}
				
				\textbf{Researcher} Ovaj entitet je razdvojeni entitet entiteta User koji sadrži atribute: username istraživača i statusId. U vezi je \textit{One-to-One} s entitetom User preko atributa username, u vezi \textit{Many-to-One} s entitetom Status preko atributa statusId.
				\begin{longtblr}[
					label=none,
					entry=none
					]{
					...
					\SetCell{LightGreen}Username & VARCHAR	&  korisničko ime istraživača\\ \hline
					\SetCell{LightBlue} StatusId	& INT &   identifikator statusa istraživača (verified, declined, pending)	\\ \hline 
				\end{longtblr}
				
				\textbf{ActionComment} Ovaj entitet sadrži informacije o komentarima ostavljenima na određenoj akciji. Sadrži atribute: actionCommentId, description, actionCommentTS, username i actionId akcije kojoj pripada. U vezi je \textit{Many-to-One} s entitetom User preko atributa username, u vezi \textit{Many-to-One} s entitetom Action preko atributa actionId.
				\begin{longtblr}[
					label=none,
					entry=none
					]{
					...
					\SetCell{LightGreen}ActionCommentId & INT	&  	Jedinstveni identifikator komentara	\\ \hline
					Description	& VARCHAR & Sadržaj komentara	\\ \hline 
					ActionCommentTS & TIMESTAMP &  Vrijeme postavljanja komentara \\ \hline 
					\SetCell{LightBlue} Username	& INT &  Identifikator korisnika koji je postavio komentar 	\\ \hline
					\SetCell{LightBlue} ActionId	& INT &   Identifikator akcije na koju je postavljen komentar	\\ \hline 
				\end{longtblr}
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue} ResearcherUser	& VARCHAR &   identifikator istraživača koji je započeo akciju	\\ \hline 
				\end{longtblr}
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue} Explorer	& VARCHAR &   Korisničko ime tragača	\\ \hline 
					\SetCell{LightBlue} ActionId	& INT &   Identifikator akcije	\\ \hline
				\end{longtblr}
				...
				\begin{longtblr}[
					...
					\SetCell{LightGreen}Username & INT	&  Korisničko ime tragača	\\ \hline
					korisnickoIme	& VARCHAR &   	\\ \hline 
					\SetCell{LightBlue} StationId	& INT &   Identifikator postaje kojoj pripada	\\ \hline 
				\end{longtblr}
				
				\textbf{ExplorerLocation} Ovaj entitet sadrži lokaciju tragača u određenom vremenu. Ima atribute: explorerLocationTS, explorer i explorerlocation. U vezi je \textit{Many-to-One} s entitetom Explorer preko atributa username.
				\begin{longtblr}[
					label=none,
					entry=none
					]{
					...
					\hline \SetCell[c=3]{c}{\textbf{korisnik - ime tablice}}	 \\ \hline[3pt]
					\SetCell{LightGreen}ExplorerLocationTS & TIMESTAMP	&  Vrijeme očitanja lokacije tragača\\ \hline
					\SetCell{LightBlue} Explorer	& VARCHAR &   Korisničko ime tragača	\\ \hline 
					ExplorerLocation	& VARCHAR &   Lokacija tragača	\\ \hline 
				\end{longtblr}
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue} Explorer	& VARCHAR &   Korisničko ime tragača koji je komentirao	\\ \hline 
					\SetCell{LightBlue} AnimalId	& INT &   identifikator komentirane životinje	\\ \hline 
				\end{longtblr}
				...
				\textbf{AnimalLocation} Ovaj entitet sadrži lokaciju životinje u određenom vremenu. Ima atribute: LocationTS, AnimalLocation, AnimalId. U vezi je \textit{Many-to-One} s entitetom Animal preko atributa animalId.
				\begin{longtblr}[
					label=none,
					entry=none
					]{
					...
					\SetCell{LightGreen}LocationTS & TIMESTAMP	&  Vrijeme zapisa lokacije životinje	\\ \hline
					AnimalLocation	& VARCHAR &   Lokacija životinje	\\ \hline
					\SetCell{LightBlue} AnimalId	& INT &   Identifikator očitane životinje	\\ \hline 
				\end{longtblr}
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue} VehicleId	& INT &   Identifikator vozila	\\ \hline 
					\SetCell{LightBlue} Explorer	& VARCHAR &   Korisničko ime tragača	\\ \hline 
				\end{longtblr}
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue} ActionId	& INT &   Identifikator akcije kojoj pripada zadatak	\\ \hline
					\SetCell{LightBlue} Explorer	& VARCHAR &   Korisničko ime tragača koji izvršava zadatak	\\ \hline 
					\SetCell{LightBlue} VehicleId	& INT &   Identifikator vozila s kojim se obavlja zadatak	\\ \hline
				\end{longtblr}
