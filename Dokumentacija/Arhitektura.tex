		...
		\end{itemize}
			...
			\subsection{Opis tablica}
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue} Researcher	& VARCHAR &   Identifikator istraživača koji šalje zahtjev, (researcher.username)	\\ \hline
					\SetCell{LightBlue} StationLead	& VARCHAR &   Identifikator voditelja koji prima zahtjev, (stationLead.username)	\\ \hline 
				\end{longtblr}
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue}Username & VARCHAR	&  korisničko ime istraživača, (user.username)\\ \hline
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue} Username	& VARCHAR &  Identifikator korisnika koji je postavio komentar, (user.username)	\\ \hline
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue} Researcher	& VARCHAR &   identifikator istraživača koji je započeo akciju, (researcher.username)	\\ \hline 
				\end{longtblr}
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue} Explorer	& VARCHAR &   Korisničko ime tragača, (explorer.username)	\\ \hline 
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue}Username & VARCHAR	&  Korisničko ime tragača, (user.username)	\\ \hline
				...
				\begin{longtblr}[
					...
					\SetCell{LightGreen}LocationTS & TIMESTAMP	&  Vrijeme očitanja lokacije tragača\\ \hline
					\SetCell{LightBlue} Explorer	& VARCHAR &   Korisničko ime tragača, (explorer.username)	\\ \hline 
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue} Explorer	& VARCHAR &   Korisničko ime tragača koji je komentirao, (explorer.username)	\\ \hline 
