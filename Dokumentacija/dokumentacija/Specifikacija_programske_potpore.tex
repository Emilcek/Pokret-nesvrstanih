\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\begin{figure}[H]
				\includegraphics[width=\textwidth]{slike/Sekvencijski_dijagram_za_UC8.PNG} %veličina u odnosu na širinu linije
				\caption{Sekvencijski dijagram za UC8}
				\label{fig:Sekvencijski_dijagram_za_UC8} %label mora biti drugaciji za svaku sliku
			\end{figure}
				...
				\begin{figure}[H]
					\includegraphics[width=\textwidth]{slike/UC19-KreiranjeAkcije} %veličina u odnosu na širinu linije
				...
				\begin{figure}[H]
					\includegraphics[width=\textwidth]{slike/UC25-PostavljanjeKomentaraNaKarti} %veličina u odnosu na širinu linije
