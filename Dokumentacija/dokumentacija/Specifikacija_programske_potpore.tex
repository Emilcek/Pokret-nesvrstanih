			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\begin{packed_item}
						...
						\item  \textbf{Sudionici:} Istraživač, tragač i baza podataka
						...
						\item[] \begin{packed_enum}
							...
							\item Administator prihvati ili odbije registraciju
					...
					\begin{packed_item}
						...
						\item  \textbf{Cilj:} Prikaz pozijcije životinje na karti
						\item  \textbf{Sudionici:} Baza podataka
						\item  \textbf{Preduvjet:} -
						\item  \textbf{Opis osnovnog tijeka:}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik u polje predodređeno za tekst upisuje ime postaje čiju geografsku poziciju želi detaljnije pogledat
						\end{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Istraživač/Tragač označuje poziciju na karti 
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Označuje određeni komentar
						\end{packed_enum}
